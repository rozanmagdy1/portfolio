  ...
  const soloProjects = [
    {
      ...
      img: IMG7,
      description:
        "Contributed to the maintenance and enhancement of BALIS, the Bibliotheca Alexandrina's core library management system, supporting millions of records and global users.",
